...
(
    ...
    restaurante_id character varying(20) COLLATE pg_catalog."default",
...
(
    ...
    apellidos character varying(20) COLLATE pg_catalog."default" NOT NULL,
    nombres character varying(20) COLLATE pg_catalog."default" NOT NULL,
    correo character varying(50) COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.app_caja
    ADD CONSTRAINT app_caja_restaurante_id_5eb98a43_fk FOREIGN KEY (restaurante_id)
...
ALTER TABLE IF EXISTS public.app_cocina
    ADD CONSTRAINT app_cocina_restaurante_id_d979c020_fk FOREIGN KEY (restaurante_id)
    REFERENCES public.app_restaurante (nit) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE IF EXISTS public.app_estado
    ADD CONSTRAINT app_estado_restaurante_id_88c8c15d_fk FOREIGN KEY (restaurante_id)
    REFERENCES public.app_restaurante (nit) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE IF EXISTS public.app_menu
    ADD CONSTRAINT app_menu_restaurante_id_06858e12_fk FOREIGN KEY (restaurante_id)
    REFERENCES public.app_restaurante (nit) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE IF EXISTS public.app_mesas
    ADD CONSTRAINT app_mesas_restaurante_id_46cbb288_fk FOREIGN KEY (restaurante_id)
    REFERENCES public.app_restaurante (nit) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE IF EXISTS public.app_oferta
    ADD CONSTRAINT app_oferta_restaurante_id_7b92efe0_fk FOREIGN KEY (restaurante_id)
    REFERENCES public.app_restaurante (nit) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE IF EXISTS public.app_pedido
    ADD CONSTRAINT app_pedido_mesero_id_ac148327_fk_app_mesero_documento FOREIGN KEY (mesero_id)
    REFERENCES public.app_mesero (documento) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX IF NOT EXISTS app_pedido_mesero_id_ac148327_like
    ON public.app_pedido(mesero_id);


ALTER TABLE IF EXISTS public.app_pedido
    ADD CONSTRAINT app_pedido_restaurante_id_1dbba5ec_fk FOREIGN KEY (restaurante_id)
    REFERENCES public.app_restaurante (nit) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
